...
/// An implementation of a transaction log without doing anything.
#[derive(Debug, Default, Inject)]
#[provides(transient = "dyn TransactionLog", no_registration)]
pub struct NoTransactionLog {}

impl TransactionLog for NoTransactionLog {
    fn log_charge(&self, _: i32) {}

    fn log_error(&self, _: &ExampleError) {}
}
...
fn main() -> Result<(), Box<dyn Error + Send + Sync + 'static>> {
    ...
    NoTransactionLog::register_override(&registry);
